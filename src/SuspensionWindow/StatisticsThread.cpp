...
StatisticsThread::StatisticsThread(QObject *parent)
	: QThread(parent), _iEnterCount(0), _iSpaceCount(0)
{
...
std::string StatisticsThread::GetKeyName(int NumKey)
{
...
bool StatisticsThread::JudgeShift()
{
...
int StatisticsThread::getSpaceCount()
{
	return _iSpaceCount;
}

int StatisticsThread::getEnterCount()
{
	return _iEnterCount;
}
